...
#        epi_nii_pref = '%s/pb02_%s_regslice' % (proc_dir, ss)
        # These are special to hel2
        epi_brain = "'%s/pb01_trim_despiked_%sr03+orig.[241]'" % (proc_dir, ss)
...
#            gp.applywarpFLIRT(ss, anat_dir, in_fl, extrt1, out_fl, premat, interpol)
...
#            gp.applywarpFNIRT(ss, anat_dir, in_fn, out_fn, fn_coef, interpol)
        """
