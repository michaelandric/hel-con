...
pdf(paste('Degrees_PowerLaw_bargraph.dens_',thresh_dens,'.pdf',sep=''))
...
pdf(paste('Degrees_ExpCutoff_bargraph.dens_',thresh_dens,'.pdf', sep=''))
...
pdf(paste('Degrees_TruncPShape_bargraph.dens_',thresh_dens,'.pdf',sep=''))
